    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <form action="<?php echo e(route('admin.addresses.store')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
...
unset($__errorArgs, $__bag); ?>" 
                                        ...
                                        <option value="">Mevcut Kullanıcı (<?php echo e(auth()->user()->first_name); ?> <?php echo e(auth()->user()->last_name); ?>)</option>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control <?php $__errorArgs = ['address_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                           id="address_name" name="address_name" value="<?php echo e(old('address_name')); ?>" 
...
unset($__errorArgs, $__bag); ?>" 
                                        ...
                                        <option value="individual" <?php echo e(old('company_type') == 'individual' ? 'selected' : ''); ?>>Bireysel</option>
                                        <option value="corporate" <?php echo e(old('company_type') == 'corporate' ? 'selected' : ''); ?>>Kurumsal</option>
                                    </select>
...
unset($__errorArgs, $__bag); ?>" 
                                           id="district" name="district" value="<?php echo e(old('district')); ?>" required>
...
unset($__errorArgs, $__bag); ?>" 
                                           id="street" name="street" value="<?php echo e(old('street')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control <?php $__errorArgs = ['road_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                           id="road_name" name="road_name" value="<?php echo e(old('road_name')); ?>">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control <?php $__errorArgs = ['building_no'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                           id="building_no" name="building_no" value="<?php echo e(old('building_no')); ?>">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control <?php $__errorArgs = ['door_no'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                           id="door_no" name="door_no" value="<?php echo e(old('door_no')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <!-- Bireysel Bilgiler -->
                        <div id="individual-info" style="display: <?php echo e(old('company_type', 'individual') == 'individual' ? 'block' : 'none'); ?>;">
                            <hr>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control <?php $__errorArgs = ['tc_id_no'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                               id="tc_id_no" name="tc_id_no" value="<?php echo e(old('tc_id_no')); ?>" 
                                               maxlength="11" pattern="[0-9]{11}" placeholder="11 haneli TC Kimlik No">
                                        <?php $__errorArgs = ['tc_id_no'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <!-- Kurumsal Bilgiler -->
                        <div id="corporate-info" style="display: <?php echo e(old('company_type') == 'corporate' ? 'block' : 'none'); ?>;">
                            <hr>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control <?php $__errorArgs = ['tax_office'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                               id="tax_office" name="tax_office" value="<?php echo e(old('tax_office')); ?>">
                                        <?php $__errorArgs = ['tax_office'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control <?php $__errorArgs = ['tax_no'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                               id="tax_no" name="tax_no" value="<?php echo e(old('tax_no')); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="card-footer">
                        ...
                        <a href="<?php echo e(route('admin.addresses.index')); ?>" class="btn btn-secondary">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Murat\Projects\laravelmv\resources\views/addresses/create.blade.php ENDPATH**/ ?>