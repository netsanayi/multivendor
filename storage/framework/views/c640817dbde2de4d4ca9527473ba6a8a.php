...
unset($__errorArgs, $__bag); ?>" 
                                                   id="product_code" name="product_code" value="<?php echo e(old('product_code')); ?>" required>
...
unset($__errorArgs, $__bag); ?>" 
                                                ...
                                                <option value="new" <?php echo e(old('condition', 'new') == 'new' ? 'selected' : ''); ?>>Sıfır</option>
                                                <option value="used" <?php echo e(old('condition') == 'used' ? 'selected' : ''); ?>>İkinci El</option>
                                                <option value="refurbished" <?php echo e(old('condition') == 'refurbished' ? 'selected' : ''); ?>>Yenilenmiş</option>
                                            </select>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control <?php $__errorArgs = ['default_price'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                                   id="default_price" name="default_price" value="<?php echo e(old('default_price')); ?>" 
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control <?php $__errorArgs = ['default_currency_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                                ...
                                                <?php $__currentLoopData = $currencies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $currency): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($currency->id); ?>" <?php echo e(old('default_currency_id', 1) == $currency->id ? 'selected' : ''); ?>>
                                                        <?php echo e($currency->name); ?> (<?php echo e($currency->symbol); ?>)
                                                    </option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                            <?php $__errorArgs = ['default_currency_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control <?php $__errorArgs = ['min_sale_quantity'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                                   id="min_sale_quantity" name="min_sale_quantity" value="<?php echo e(old('min_sale_quantity', 1)); ?>" 
                                                   min="1" required>
                                            <?php $__errorArgs = ['min_sale_quantity'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control <?php $__errorArgs = ['max_sale_quantity'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                                   id="max_sale_quantity" name="max_sale_quantity" value="<?php echo e(old('max_sale_quantity', 10)); ?>" 
                                                   min="1" required>
                                            <?php $__errorArgs = ['max_sale_quantity'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                                   id="length" name="length" value="<?php echo e(old('length')); ?>" 
                                                   step="0.01" min="0">
...
unset($__errorArgs, $__bag); ?>" 
                                                   id="width" name="width" value="<?php echo e(old('width')); ?>" 
                                                   step="0.01" min="0">
...
unset($__errorArgs, $__bag); ?>" 
                                           id="tags" name="tags" value="<?php echo e(old('tags')); ?>" data-role="tagsinput">
                        ...
                        <div class="row mt-4">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control <?php $__errorArgs = ['approval_status'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                        ...
                                        <option value="approved" <?php echo e(old('approval_status', 'approved') == 'approved' ? 'selected' : ''); ?>>Onaylı</option>
                                        <option value="pending" <?php echo e(old('approval_status') == 'pending' ? 'selected' : ''); ?>>Onay Bekliyor</option>
                                    </select>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Murat\Projects\laravelmv\resources\views/products/create.blade.php ENDPATH**/ ?>