...
<head>
    ...
    <title><?php echo e(config('app.name', 'Laravel')); ?> - Admin Panel - <?php echo $__env->yieldContent('title', 'Dashboard'); ?></title>
        ...
        <div class="p-6 border-b border-gray-800">
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-3">
                    <img src="<?php echo e(asset('assets/html/dist/assets/media/app/mini-logo-circle-primary.svg')); ?>" alt="Logo" class="w-10 h-10">
        ...
        <nav class="py-4">
            ...
            <div>
                ...
                <div class="sidebar-dropdown" id="products-dropdown">
                    <a href="<?php echo e(route('admin.products.index')); ?>" class="sidebar-dropdown-item">Tüm Ürünler</a>
                    <a href="<?php echo e(route('admin.products.create')); ?>" class="sidebar-dropdown-item">Yeni Ürün</a>
                    <a href="<?php echo e(route('admin.categories.index')); ?>" class="sidebar-dropdown-item">Kategoriler</a>
                    <a href="<?php echo e(route('admin.brands.index')); ?>" class="sidebar-dropdown-item">Markalar</a>
                    <a href="<?php echo e(route('admin.product-attributes.index')); ?>" class="sidebar-dropdown-item">Ürün Özellikleri</a>
                    <a href="<?php echo e(route('admin.attribute-categories.index')); ?>" class="sidebar-dropdown-item">Özellik Kategorileri</a>
                </div>
            </div>
            ...
            <!-- Vendor Products -->
            <a href="<?php echo e(route('admin.vendor-products.index')); ?>" class="sidebar-menu-item <?php echo e(request()->routeIs('admin.vendor-products.*') ? 'active' : ''); ?>">
            ...
            <!-- Wishlists -->
            <a href="<?php echo e(route('wishlist.index')); ?>" class="sidebar-menu-item <?php echo e(request()->routeIs('wishlist.*') ? 'active' : ''); ?>">
            ...
            <div>
                ...
                <div class="sidebar-dropdown" id="users-dropdown">
                    <a href="<?php echo e(route('admin.users.index')); ?>" class="sidebar-dropdown-item">Tüm Kullanıcılar</a>
                    <a href="<?php echo e(route('admin.users.create')); ?>" class="sidebar-dropdown-item">Yeni Kullanıcı</a>
                    <a href="<?php echo e(route('admin.roles.index')); ?>" class="sidebar-dropdown-item">Roller</a>
                    <a href="<?php echo e(route('admin.vendors.list') ?? '#'); ?>" class="sidebar-dropdown-item">Satıcılar</a>
                    <a href="<?php echo e(route('admin.addresses.index')); ?>" class="sidebar-dropdown-item">Adresler</a>
                </div>
            </div>
            
            <!-- Vendor Dashboard -->
            <a href="<?php echo e(route('vendor.dashboard') ?? '#'); ?>" class="sidebar-menu-item <?php echo e(request()->routeIs('vendor.*') ? 'active' : ''); ?>">
                <i class="ki-duotone ki-shop fs-2x">
                    <span class="path1"></span>
                    <span class="path2"></span>
                    <span class="path3"></span>
            ...
            <!-- Blog -->
            <a href="<?php echo e(route('admin.blogs.index')); ?>" class="sidebar-menu-item <?php echo e(request()->routeIs('admin.blogs.*') ? 'active' : ''); ?>">
            ...
            <!-- Banners -->
            <a href="<?php echo e(route('admin.banners.index')); ?>" class="sidebar-menu-item <?php echo e(request()->routeIs('admin.banners.*') ? 'active' : ''); ?>">
            ...
            <!-- Tickets -->
            <a href="<?php echo e(route('tickets.index') ?? '#'); ?>" class="sidebar-menu-item <?php echo e(request()->routeIs('tickets.*') ? 'active' : ''); ?>">
            ...
            <!-- Messages -->
            <a href="<?php echo e(route('messages.index') ?? '#'); ?>" class="sidebar-menu-item <?php echo e(request()->routeIs('messages.*') ? 'active' : ''); ?>">
            ...
            <!-- Notifications -->
            <a href="<?php echo e(route('notifications.index') ?? '#'); ?>" class="sidebar-menu-item <?php echo e(request()->routeIs('notifications.*') ? 'active' : ''); ?>">
            ...
            <!-- Settings -->
            <a href="<?php echo e(route('admin.settings.index')); ?>" class="sidebar-menu-item <?php echo e(request()->routeIs('admin.settings.*') ? 'active' : ''); ?>">
            ...
            <!-- Languages -->
            <a href="<?php echo e(route('admin.languages.index')); ?>" class="sidebar-menu-item <?php echo e(request()->routeIs('admin.languages.*') ? 'active' : ''); ?>">
            ...
            <!-- Currencies -->
            <a href="<?php echo e(route('admin.currencies.index')); ?>" class="sidebar-menu-item <?php echo e(request()->routeIs('admin.currencies.*') ? 'active' : ''); ?>">
            ...
            <!-- Activity Log -->
            <a href="<?php echo e(route('admin.activity-log.index')); ?>" class="sidebar-menu-item <?php echo e(request()->routeIs('admin.activity-log.*') ? 'active' : ''); ?>">
    ...
    <header class="admin-header">
        <div class="h-full px-6 flex items-center justify-between">
            <div class="flex items-center gap-4">
                <h1 class="text-2xl font-bold text-gray-800"><?php echo $__env->yieldContent('page-title', 'Dashboard'); ?></h1>
            ...
            <div class="flex items-center gap-4">
                ...
                <div class="relative" x-data="{ open: false }">
                    <button @click="open = !open" class="flex items-center gap-3">
                        <img src="<?php echo e(Auth::user()->profile_photo_url ?? asset('assets/html/dist/assets/media/avatars/300-1.png')); ?>" alt="User" class="w-10 h-10 rounded-full">
                        <div class="text-left">
...
<?php /**PATH C:\Users\Murat\Projects\laravelmv\resources\views/layouts/admin.blade.php ENDPATH**/ ?>