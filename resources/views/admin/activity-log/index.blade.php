            ...
            <form method="GET" action="{{ route('admin.activity-log.index') }}" class="row g-3">
                <div class="col-md-3">
                    ...
                    <input type="text" class="form-control" id="search" name="search" 
                           value="{{ request('search') }}" placeholder="Açıklama veya özellik...">
                </div>
                <div class="col-md-2">
                            ...
                            @foreach($activities as $activity)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @if($activity->event)
                                            <span class="badge bg-info ms-1">{{ $activity->event }}</span>
                                        @endif
                                    </td>
                                    <td>
                                        @if($activity->subject)
...
<div class="modal fade" id="exportModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{ route('admin.activity-log.export') }}" method="GET">
                ...
                <div class="modal-body">
                    ...
                    @if(request()->anyFilled(['search', 'log_name', 'subject_type', 'start_date', 'end_date']))
                        ...
                        @foreach(request()->only(['search', 'log_name', 'subject_type', 'start_date', 'end_date']) as $key => $value)
                            @if($value)
