...
<head>
    ...
    <title>{{ config('app.name', 'Laravel') }} - @yield('title', 'Multi-Vendor Marketplace')</title>
                ...
                <div class="flex items-center justify-between h-16">
                    ...
                    <div class="flex items-center space-x-8">
                        ...
                        <nav class="hidden lg:flex items-center space-x-6">
                            <a href="{{ route('dashboard') }}" class="text-gray-700 hover:text-purple-600 font-medium transition-colors">
                                Ana Sayfa
                            </a>
                            ...
                            <a href="{{ route('vendor.dashboard') }}" class="text-gray-700 hover:text-purple-600 font-medium transition-colors">
                                Satıcı Paneli
                            </a>
                            @endif
                            @if(auth()->user() && auth()->user()->hasRole('admin'))
                            <a href="{{ route('admin.dashboard') }}" class="text-gray-700 hover:text-purple-600 font-medium transition-colors">
                                Yönetim
                            </a>
                            @endif
                        </nav>
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <!-- Messages -->
                        <div class="relative">
                            <a href="{{ route('messages.index') }}" class="text-gray-600 hover:text-gray-900 relative">
                        ...
                        <!-- Wishlist -->
                        <a href="{{ route('wishlist.index') }}" class="text-gray-600 hover:text-gray-900">
                        ...
                        <div class="relative" x-data="{ open: false }">
                            <button @click="open = !open" class="flex items-center space-x-3 text-gray-700 hover:text-gray-900">
                                <img src="{{ asset('assets/html/dist/assets/media/avatars/300-1.png') }}" alt="User" class="w-10 h-10 rounded-full border-2 border-purple-500">
                            ...
                            <div x-show="open" @click.away="open = false" x-transition class="absolute right-0 mt-2 w-56 dropdown-menu">
                                <div class="py-2">
                                    <a href="{{ route('profile.show') }}" class="dropdown-item flex items-center space-x-3">
                                    ...
                                    <a href="{{ route('wishlist.index') }}" class="dropdown-item flex items-center space-x-3">
        ...
        <div id="mobile-sidebar" class="fixed inset-0 z-40 lg:hidden hidden">
            ...
            <nav class="fixed top-0 left-0 bottom-0 w-64 bg-white shadow-xl overflow-y-auto">
                <div class="p-4">
                    ...
                    <img src="{{ asset('assets/html/dist/assets/media/app/default-logo.svg') }}" alt="Logo" class="h-10 w-auto mb-6">
                    
                    <div class="space-y-2">
                        <a href="{{ route('dashboard') }}" class="block px-4 py-3 text-gray-700 hover:bg-purple-50 hover:text-purple-600 rounded-lg">
                        ...
                        @if(auth()->user() && auth()->user()->hasRole('vendor'))
                        <a href="{{ route('vendor.dashboard') }}" class="block px-4 py-3 text-gray-700 hover:bg-purple-50 hover:text-purple-600 rounded-lg">
                        ...
                        @endif
                        @if(auth()->user() && auth()->user()->hasRole('admin'))
                        <a href="{{ route('admin.dashboard') }}" class="block px-4 py-3 text-gray-700 hover:bg-purple-50 hover:text-purple-600 rounded-lg">
        ...
        <footer class="bg-gray-900 text-white mt-auto">
            <div class="container mx-auto px-4 py-12">
                ...
                <div class="flex flex-col md:flex-row justify-between items-center">
                    <p class="text-gray-400">&copy; 2024 {{ config('app.name') }}. Tüm hakları saklıdır.</p>
