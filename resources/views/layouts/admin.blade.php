                        ...
                        <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                            ...
                            <div class="hidden sm:flex sm:items-center sm:ml-6">
                                <x-dropdown align="right" width="48">
                                    ...
                                    <x-slot name="content">
                                        ...
                                        <x-dropdown-link href="{{ route('admin.vendor-products.index') }}">
                                            {{ __('Satıcı Ürünleri') }}
                                        </x-dropdown-link>
                                        <x-dropdown-link href="{{ route('admin.brands.index') }}">
                                            {{ __('Markalar') }}
                                        </x-dropdown-link>
                                        <x-dropdown-link href="{{ route('admin.product-attributes.index') }}">
                                            {{ __('Ürün Özellikleri') }}
                                        </x-dropdown-link>
                                        <x-dropdown-link href="{{ route('admin.attribute-categories.index') }}">
                                            {{ __('Özellik Kategorileri') }}
                                        </x-dropdown-link>
                                    </x-slot>
                                </x-dropdown>
                            </div>
                            ...
                            <div class="hidden sm:flex sm:items-center sm:ml-6">
                                <x-dropdown align="right" width="48">
                                    ...
                                    <x-slot name="content">
                                        ...
                                        <x-dropdown-link href="{{ route('admin.addresses.index') }}">
                                            {{ __('Adresler') }}
                                        </x-dropdown-link>
                                    </x-slot>
                                </x-dropdown>
                            ...
                            <div class="hidden sm:flex sm:items-center sm:ml-6">
                                <x-dropdown align="right" width="48">
                                    ...
                                    <x-slot name="content">
                                        <x-dropdown-link href="{{ route('admin.currencies.index') }}">
                                            {{ __('Para Birimleri') }}
                                        </x-dropdown-link>
