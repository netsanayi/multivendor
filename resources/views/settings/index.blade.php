                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            ...
                            <a href="{{ route('admin.settings.optimize') }}" class="btn btn-info btn-sm"
                            ...
                            <div class="tab-pane fade show active" id="general" role="tabpanel">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="maintenance_mode" 
                                                ...
                                                <option value="0" {{ ($settings['general']['maintenance_mode'] ?? '0') == '0' ? 'selected' : '' }}>Kapalı</option>
                                                <option value="1" {{ ($settings['general']['maintenance_mode'] ?? '0') == '1' ? 'selected' : '' }}>Açık</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="app_description" 
                                              name="settings[app_description]" rows="3">{{ $settings['general']['app_description'] ?? '' }}</textarea>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            @if($settings['general']['app_logo'] ?? false)
                                                <div class="mb-2">
                                                    <img src="{{ $settings['general']['app_logo'] }}" alt="Logo" 
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            @if($settings['general']['app_favicon'] ?? false)
                                                <div class="mb-2">
                                                    <img src="{{ $settings['general']['app_favicon'] }}" alt="Favicon" 
                            ...
                            <div class="tab-pane fade" id="contact" role="tabpanel">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="contact_address" 
                                              name="settings[contact_address]" rows="3">{{ $settings['contact']['contact_address'] ?? '' }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="tab-pane fade" id="seo" role="tabpanel">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="seo_description" 
                                              name="settings[seo_description]" rows="3">{{ $settings['seo']['seo_description'] ?? '' }}</textarea>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="google_analytics" 
                                              ...
                                              placeholder="Google Analytics izleme kodunu buraya yapıştırın">{{ $settings['seo']['google_analytics'] ?? '' }}</textarea>
                                </div>
                            </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" id="commission_rate" 
                                                   ...
                                                   value="{{ $settings['marketplace']['commission_rate'] ?? '10' }}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" id="min_payout_amount" 
                                                   ...
                                                   value="{{ $settings['marketplace']['min_payout_amount'] ?? '100' }}"
                                                   min="0" step="0.01">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="auto_approve_products" 
                                                ...
                                                <option value="0" {{ ($settings['marketplace']['auto_approve_products'] ?? '0') == '0' ? 'selected' : '' }}>Hayır</option>
                                                <option value="1" {{ ($settings['marketplace']['auto_approve_products'] ?? '0') == '1' ? 'selected' : '' }}>Evet</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="vendor_registration" 
                                                ...
                                                <option value="1" {{ ($settings['marketplace']['vendor_registration'] ?? '1') == '1' ? 'selected' : '' }}>Evet</option>
                                                <option value="0" {{ ($settings['marketplace']['vendor_registration'] ?? '1') == '0' ? 'selected' : '' }}>Hayır</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="enable_2fa" 
                                                ...
                                                <option value="0" {{ ($settings['security']['enable_2fa'] ?? '0') == '0' ? 'selected' : '' }}>Devre Dışı</option>
                                                <option value="1" {{ ($settings['security']['enable_2fa'] ?? '0') == '1' ? 'selected' : '' }}>Aktif</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <div class="custom-control custom-switch">
                                                ...
                                                <input type="checkbox" class="custom-control-input" id="password_require_uppercase"
                                                       ...
                                                       {{ ($settings['security']['password_require_uppercase'] ?? '1') == '1' ? 'checked' : '' }}>
                                        ...
                                        <div class="form-group">
                                            <div class="custom-control custom-switch">
                                                ...
                                                <input type="checkbox" class="custom-control-input" id="password_require_numbers"
                                                       ...
                                                       {{ ($settings['security']['password_require_numbers'] ?? '1') == '1' ? 'checked' : '' }}>
                                        ...
                                        <div class="form-group">
                                            <div class="custom-control custom-switch">
                                                ...
                                                <input type="checkbox" class="custom-control-input" id="password_require_symbols"
                                                       ...
                                                       {{ ($settings['security']['password_require_symbols'] ?? '1') == '1' ? 'checked' : '' }}>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" id="lockout_duration" 
                                                   ...
                                                   value="{{ $settings['security']['lockout_duration'] ?? '60' }}"
                                                   min="15" max="1440">
                                        </div>
                                    </div>
                                </div>
