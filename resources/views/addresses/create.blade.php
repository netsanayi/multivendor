                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('address_name') is-invalid @enderror" 
                                           id="address_name" name="address_name" value="{{ old('address_name') }}" 
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('building_no') is-invalid @enderror" 
                                           id="building_no" name="building_no" value="{{ old('building_no') }}">
                                    @error('building_no')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('door_no') is-invalid @enderror" 
                                           id="door_no" name="door_no" value="{{ old('door_no') }}" required>
                                    @error('door_no')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
