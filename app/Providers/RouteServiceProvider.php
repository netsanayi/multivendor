...
class RouteServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        Route::bind('vendorProduct', function ($value) {
            return \App\Modules\VendorProducts\Models\VendorProduct::findOrFail($value);
        });

        Route::bind('productAttribute', function ($value) {
            return \App\Modules\ProductAttributes\Models\ProductAttribute::findOrFail($value);
        });
